package be.kdg.prog6.family.adapter.out.appointmentActivity;

import be.kdg.prog6.family.adapter.out.appointment.AppointmentJpaEntity;
import be.kdg.prog6.family.adapter.out.warehouse.WarehouseJpaEntity;
import be.kdg.prog6.family.domain.ActivityType;
